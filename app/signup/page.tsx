        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#035efc]/10 to-white px-6 py-16">
            ...
            >
                ...
                <div className="w-1/2 p-10 flex flex-col justify-center">
                    <h1 className="text-3xl font-bold text-[#035efc] mb-1">Create Account</h1>
                    <p className="text-sm text-gray-500 mb-6">Join MeetYou — your 1:1 meeting space.</p>
                            ...
                            <AnimatePresence>
                                {confirmPassword.length > 0 && (
                                    <motion.p
                                        ...
                                        animate={{ opacity: 1, y: 0 }}
                                        exit={{ opacity: 0 }}
                                        className={`text-xs mt-1 ${passwordsMatch ? "text-green-600" : "text-red-500"}`}
                                    >
                    ...
                    <p className="text-center text-sm text-gray-500 mt-5">
                        ...
                        <Link href="/login" className="text-[#035efc] font-medium hover:underline">
                            Sign in
                        </Link>
                    </p>
                </div>
